...
input_ref_traj = '../trajectories/3site_toy.lammpstrj'
input_cg_traj = '../trajectories/3site_REM_trial_toy.lammpstrj'

output_dir ='output/'
input_dir  ='input/'
reference_dir ='reference/'

filesToCheck = ['A_A.dat', 'A_B.dat', 'A_C.dat', 'B_B.dat', 'B_C.dat', 'C_C.dat']
